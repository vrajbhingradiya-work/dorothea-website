  ...
  return (
    <section className="bg-primary-default py-8 pb-16" ref={ref}>
      <div className="relative overflow-hidden py-24">
        <div className="hidden xl:block absolute top-0 left-0 h-[75%] w-[30%] z-20 bg-primary-default/50"></div>
        <div className="hidden xl:block absolute top-0 right-0 h-[75%] w-[25%] z-20 bg-primary-default/50"></div>
