  ...
  return (
    ...
    >
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: false }}
        className={`top-28 h-[100vh] md:h-[85vh]  flex items-center overflow-hidden  ${
      ...
      >
        <motion.div
          ...
          className="flex   p-6 "
        >
          <div className="flex flex-col  justify-center items-start gap-8 h-[450px] xl:h-[85vh]  xl:w-[50vw]  ">
...
const Card = ({
  ...
  return (
    <div
      key={card.id}
      className="group relative h-[450px] xl:h-[85vh] w-[100vw] xl:w-[45vw]  px-12 overflow-hidden bg-neutral-200 border-l-2  border-secondary-default"
    >
