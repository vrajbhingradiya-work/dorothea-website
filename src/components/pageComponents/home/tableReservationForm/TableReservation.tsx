  ...
  return (
    <div id="booking" className="   flex items-center justify-center">
      <div className="  flex gap-4 justify-center items-center w-full lg:max-w-full">
        <div className="flex flex-col justify-between  xl:p-6 w-full lg:min-w-[85%]">
          ...
          <form
            className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-8 w-full text-sm xl:text-base"
